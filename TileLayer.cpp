...
#include <iostream>  //clw modify £ºfor cout
using namespace std;  //clw modify £ºfor cout
...
//    m_mapWidth = mapWidth;
//}
TileLayer::TileLayer(int tileSize, int mapWidth, int mapHeight, const std::vector<Tileset>& tilesets) : m_tileSize(tileSize), m_tilesets(tilesets)
{
    ;
}
...
//            }
//
//            if(j == 0)  //clw note£º for test
//				cout << (j * m_tileSize) - x2 - TheCamera::Instance()->getPosition().m_x << endl; //clw note£º for test
//
